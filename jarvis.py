...
def sendEmail(to, content):
    ...
    server.ehlo()
    server.starttls()
    server.login('deadshot9658@gmail.com', 'Rock@9821')
    server.sendmail("jayadavade2000@gmail.com", to, content)
    server.close()
    ...
    def TaskExecution(self):
        ...
        while True:
            ...
            if "open Notepad" in self.query:
                ...
                kit.sendwhatmsg("+917045254989", "testing whatsapp", 3, 00)


            elif "song on YouTube" in self.query:
                kit.playonyt("see you again")

            elif "send email to Jay" in self.query:
                try:
                    speak("what should i say")
                    content = self.takecommand().lower()
                    to = "jayadavade2000@gmail.com"
...
class Main(QMainWindow):
    ...
    def startTask(self):
        self.ui.movie = QtGui.QMovie("C:/Users/Hemanth/Desktop/JarvisGUI/jarvis Gif/Jarvis.gif")
        self.ui.label.setMovie(self.ui.movie)
        self.ui.movie.start()
        self.ui.movie = QtGui.QMovie("C:/Users/Hemanth/Desktop/JarvisGUI/jarvis Gif/jar3.gif")
        self.ui.label_2.setMovie(self.ui.movie)
        self.ui.movie.start()
        self.ui.movie = QtGui.QMovie("C:/Users/Hemanth/Desktop/JarvisGUI/jarvis Gif/Loading.gif")
        self.ui.label_3.setMovie(self.ui.movie)
        self.ui.movie.start()
        self.ui.movie = QtGui.QMovie("C:/Users/Hemanth/Desktop/JarvisGUI/jarvis Gif/Jar2-1.gif")
